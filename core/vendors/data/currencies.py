...
Currency = namedtuple("Currency", ["name", "iso", "symbol", "num"])


CURRENCY_LIST = [
    Currency(_("Ruble"), "RUB", "₽", 643),
    Currency(_("Dollar"), "USD", "$", 840),
]
...
Bolivia	Bolivian Bolíviano	BOB	$b
...
Guatemala	Guatemala Quetzal	GTQ	Q
Guernsey – Channel Islands	Guernsey Pound	GGP	£
Guyana	Guyana Dollar	GYD	$
Honduras	Honduras Lempira	HNL	L
Hong Kong	Hong Kong Dollar	HKD	$
Hungary	Hungary Forint	HUF	Ft
Iceland	Iceland Krona	ISK	kr
India	India Rupee	INR	₹
Indonesia	Indonesia Rupiah	IDR	Rp
Iran	Iran Rial	IRR	﷼
...
Turkey	Turkey Lira	TRY	₺
Tuvalu	Tuvalu Dollar	TVD	$
...
Uruguay	Uruguay Peso	UYU	$U
Uzbekistan	Uzbekistan Som	UZS	лв
Venezuela	Venezuela Bolívar	VEF	Bs
Vietnam	Viet Nam Dong	VND	₫
Yemen	Yemen Rial	YER	﷼
Benin
Burkina Faso
Guinea-Bissau
Ivory Coast
...
Zimbabwe	Zimbabwe Dollar	ZWD	Z$
"""
